  ...
  >
    <nav class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
      ...
      <div class="flex items-center gap-3">
        ...
        <button
          @click="toggleMode"
          class="w-9 h-9 rounded-lg flex items-center justify-center border dark:bg-[rgba(255,255,255,0.04)] dark:border-[rgba(255,255,255,0.08)] bg-white border-gray-200 dark:hover:bg-[rgba(255,255,255,0.08)] hover:bg-gray-100 hover:border-electric-500/40 transition-colors shadow-sm"
          :aria-label="isDark ? 'Passer en mode clair' : 'Passer en mode sombre'"
        >
          <svg v-if="isDark" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          ...
          <svg v-else xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-navy-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <button
          ...
          class="md:hidden w-9 h-9 rounded-lg flex items-center justify-center border dark:bg-[rgba(255,255,255,0.04)] dark:border-[rgba(255,255,255,0.08)] bg-white border-gray-200 shadow-sm"
          aria-label="Menu"
        >
