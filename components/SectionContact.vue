        ...
        <div class="space-y-6 reveal reveal-delay-1">
          ...
          <div class="dark:bg-dark-card bg-white dark:border-electric-500/20 border-electric-500/20 border-2 rounded-xl p-5 shadow-card-dark">
            <div class="flex items-center gap-2 mb-3">
              ...
              <span class="dark:text-gray-300 text-gray-600 text-xs font-medium">Disponible pour des projets via Pure Web Agency</span>
            </div>
            <p class="dark:text-gray-400 text-gray-500 text-sm leading-relaxed">
              Pour les devis et collaborations professionnelles, contactez directement via <a href="https://purewebagency.com" target="_blank" rel="noopener" class="dark:text-electric-400 text-electric-600 hover:underline font-medium">purewebagency.com</a>.
            </p>
          </div>
        </div>
...
const contactInfo = [
  ...
  {
    label: 'Agence',
    value: 'purewebagency.com',
    href: 'https://purewebagency.com',
    external: true,
    color: 'linear-gradient(135deg, #1E3A5F, #0F2044)',
    icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',
  },
  {
    label: 'Localisation',
