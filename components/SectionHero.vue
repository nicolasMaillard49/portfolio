    ...
    <div class="relative z-10 max-w-6xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div class="space-y-8">
        ...
        <div class="flex items-center flex-wrap gap-x-4 gap-y-2 pt-1">
          ...
          <span class="w-px h-4 dark:bg-dark-border bg-gray-300" />
          <span
            class="flex items-center gap-1.5 dark:text-gray-400 text-gray-500 text-sm"
            title="Aucun déplacement nécessaire — visio ou validation en ligne"
          >
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <!-- Trust signals -->
        <div class="flex items-center flex-wrap gap-4 pt-1">
          <div class="flex items-center gap-1.5">
            <div class="flex items-center gap-0.5">
              <svg v-for="n in 5" :key="n" class="w-4 h-4 text-yellow-400" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2l2.954 6.31 6.962.637-5.241 4.744 1.528 6.824L12 17.3l-6.203 3.215 1.528-6.824L2.084 8.947l6.962-.637L12 2z"/>
              </svg>
            </div>
            <span class="dark:text-gray-300 text-gray-700 text-sm font-medium">5/5</span>
          </div>
          <span class="w-px h-4 dark:bg-dark-border bg-gray-300" />
          <span class="flex items-center gap-1.5 dark:text-gray-400 text-gray-500 text-sm">
            ...
            <span class="dark:text-gray-300 text-gray-700 font-medium">100%</span>
