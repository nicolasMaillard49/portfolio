    ...
    <div class="max-w-6xl mx-auto px-6">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        <TransitionGroup name="project-grid">
          ...
          >
            <!-- Image placeholder -->
            <div class="relative h-44 overflow-hidden dark:bg-gradient-to-br bg-gradient-to-br flex items-center justify-center"
              ...
              <!-- Featured badge -->
              <div v-if="project.featured" class="absolute top-3 left-3 px-2.5 py-1 bg-electric-500 rounded-full text-white text-[10px] font-semibold tracking-wide">
                ⭐ Mis en avant
              </div>
              <!-- Live badge -->
              <div v-if="project.live" class="absolute top-3 right-3 flex items-center gap-1 px-2.5 py-1 bg-black/30 backdrop-blur-sm rounded-full text-white text-[10px] font-medium">
...
const filters = ['Tous', 'Vue.js', 'Nuxt', 'TypeScript', 'NestJS', 'E-commerce']
...
const projects = [
  ...
  },
  {
    ...
    description: 'Site vitrine pour le club de boxe de Pessac. Présentation des cours, horaires, galerie photos. Construit avec Vue/Nuxt pour des performances optimales.',
    type: 'Site Vitrine',
  ...
  },
  {
    ...
    description: 'Site vitrine pour un artisan charpentier bordelais. Présentation des réalisations, devis en ligne, SEO local optimisé. Vue/Nuxt/TypeScript.',
    type: 'Site Vitrine',
  ...
  },
  {
    ...
    description: 'Système de réservation générique et réutilisable. Architecture modulaire Vue.js adaptable à différents types de services.',
    type: 'Application Web',
    tech: ['Vue.js', 'JavaScript'],
    github: 'https://github.com/nicolasMaillard49/booking-system',
    url: null,
    live: false,
    featured: false,
