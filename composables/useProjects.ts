...
const projects: Project[] = [
  {
    ...
    details: {
      ...
      challenges: [
        ...
        "Optimiser les fiches produits pour le SEO et la conversion",
        "Garantir des performances mobiles irréprochables, cible principale du trail",
      ],
      features: [
        { icon: '🏃', title: 'Catalogue trail', description: "Sélection d'équipements (chaussures, sacs, accessoires) filtrable par catégorie et usage." },
        { icon: '💳', title: 'Paiement Stripe', description: "Checkout sécurisé PCI-DSS, Apple Pay et Google Pay supportés nativement." },
        { icon: '📦', title: 'Suivi de commande', description: "Emails transactionnels automatiques et statut de commande consultable côté client." },
        { icon: '⚡', title: 'Performance Nuxt', description: "SSR, lazy loading des images et score Lighthouse au top sur mobile." },
      ],
      stackDetails: [
        { name: 'Nuxt 3', reason: "SSR pour un SEO e-commerce optimal et une UX fluide entre fiches produits." },
        { name: 'Stripe', reason: "Paiement sécurisé, intégration rapide et frais compétitifs." },
