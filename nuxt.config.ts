  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:url', content: 'https://nmf-agence.com' },
        { property: 'og:image', content: 'https://nmf-agence.com/og-image.png' },
        ...
        { name: 'twitter:image', content: 'https://nmf-agence.com/og-image.png' },
        { name: 'twitter:image:alt', content: 'NMF Agence — Agence Web Full-Stack Bordeaux' },
      ],
      link: [
        { rel: 'canonical', href: 'https://nmf-agence.com' },
        ...
        },
        {
          ...
          innerHTML: JSON.stringify({
            ...
            '@graph': [
              {
                '@type': 'WebSite',
                '@id': 'https://nmf-agence.com/#website',
                url: 'https://nmf-agence.com',
                name: 'NMF Agence',
                description: 'Agence Web Full-Stack Bordeaux',
                inLanguage: 'fr-FR',
                publisher: { '@id': 'https://nmf-agence.com/#organization' },
              },
              {
                '@type': ['Organization', 'LocalBusiness'],
                '@id': 'https://nmf-agence.com/#organization',
                name: 'NMF Agence',
                url: 'https://nmf-agence.com',
                logo: {
                  '@type': 'ImageObject',
                  url: 'https://nmf-agence.com/og-image.png',
                  width: 1200,
                  height: 630,
                },
                image: 'https://nmf-agence.com/og-image.png',
              ...
              },
              {
                ...
                provider: { '@id': 'https://nmf-agence.com/#organization' },
              ...
              },
              {
                '@type': 'BreadcrumbList',
                itemListElement: [
                  { '@type': 'ListItem', position: 1, name: 'Accueil', item: 'https://nmf-agence.com' },
                ],
              },
              {
                '@type': 'WebPage',
                '@id': 'https://nmf-agence.com/#webpage',
                url: 'https://nmf-agence.com',
                ...
                isPartOf: { '@id': 'https://nmf-agence.com/#website' },
                about: { '@id': 'https://nmf-agence.com/#organization' },
                inLanguage: 'fr-FR',
              },
            ],
          }),
